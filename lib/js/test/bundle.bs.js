...
function getBBox(elem) {
  var rect = Curry._1(Natives.getBBox, elem);
  console.log(rect);
  return /* record */[
          /* leftTop : float array */[
            rect.x,
...
function getLeftTop(elem) {
  return Box.getBBox(elem)[/* leftTop */0];
}

function setLeftTop(vec2, elem) {
  var prev = Box.getBBox(elem)[/* leftTop */0];
  var delta = Vec2.$neg$caret(vec2, prev);
  return move(delta, elem);
}

function getRightBottom(elem) {
  return Box.getBBox(elem)[/* rightBottom */1];
}

function getCenter(elem) {
  var box = Box.getBBox(elem);
...
function setCenter(vec2, elem) {
  var delta = Vec2.$neg$caret(vec2, getCenter(elem));
  return move(delta, elem);
}
...
function setSize(vec2, elem) {
  return zoom(Vec2.$slash$caret(vec2, getSize(elem)), elem);
}
...
var Option       = require("bs-batteries/lib/js/src/option.js");
var Parsers      = require("../src/parsers.bs.js");
...
it("coordinates", (function () {
        Mocha.floatEq("leftTop", Svg.getLeftTop(circle(/* () */0))[/* x */0], 10.0);
        Mocha.floatEq("center", Svg.getCenter(circle(/* () */0))[/* x */0], 20.0);
        Mocha.floatEq("rightBottom", Svg.getRightBottom(circle(/* () */0))[/* x */0], 30.0);
        Svg.setLeftTop(/* float array */[
              0.0,
              10.0
            ], circle(/* () */0));
        Mocha.floatEq("leftTop'", Svg.getLeftTop(circle(/* () */0))[/* x */0], 0.0);
        Mocha.floatEq("center'", Svg.getCenter(circle(/* () */0))[/* x */0], 10.0);
        return Mocha.floatEq("rightBottom'", Svg.getRightBottom(circle(/* () */0))[/* x */0], 20.0);
      }));
...
it("parsers", (function () {
        var match = Parsers.parseRgb("rgb(5, 10, 15)");
        if (typeof match === "number") {
          return Mocha.fail("not Rgb");
        } else if (match.tag) {
          var rgb = match[0];
          Mocha.intEq("color r", rgb[/* r */0], 5);
          Mocha.intEq("color g", rgb[/* g */1], 10);
          return Mocha.intEq("color b", rgb[/* b */2], 15);
        } else {
          return Mocha.fail("not Rgb");
        }
      }));
