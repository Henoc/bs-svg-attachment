...
},{"./natives.bs.js":2,"bs-platform/lib/js/curry.js":34,"bs-platform/lib/js/pervasives.js":40}],2:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.1.0, PLEASE EDIT WITH CARE
'use strict';
...
var Parser$BsLittleParser = require("bs-little-parser/lib/js/src/parser.bs.js");
...
function parseD(s) {
  var opParser = Parser$BsLittleParser.regex((/[mMlLhHvVaAqQtTcCsSzZ]/));
  var floatParser = Parser$BsLittleParser.regex((/[+-]?[0-9]+(\.[0-9]*)?([eE][+-]?[0-9]+)?/));
  var floatPairParser = Parser$BsLittleParser.$caret$caret(Parser$BsLittleParser.$less$star$great(floatParser, floatParser), (function (param) {
          return /* float array */[
                  Caml_format.caml_float_of_string(param[0]),
                  Caml_format.caml_float_of_string(param[1])
                ];
        }));
  var partial_arg = Parser$BsLittleParser.$caret$caret(Parser$BsLittleParser.$less$star$great(opParser, (function (param) {
              return Parser$BsLittleParser.rep(floatPairParser, param);
            })), (function (param) {
          return /* record */[
                  /* operator */param[0],
                  /* points */param[1]
  ...
  var pathParser = function (param) {
    return Parser$BsLittleParser.rep(partial_arg, param);
  };
  var match = Curry._1(pathParser, /* record */[
        /* text */s,
        /* index */0,
        /* whitespace */" ,\n"
      ]);
...
},{"bs-little-parser/lib/js/src/parser.bs.js":11,"bs-platform/lib/js/array.js":12,"bs-platform/lib/js/block.js":14,"bs-platform/lib/js/caml_array.js":16,"bs-platform/lib/js/caml_format.js":19,"bs-platform/lib/js/curry.js":34,"bs-platform/lib/js/js_primitive.js":36,"bs-platform/lib/js/list.js":37,"bs-platform/lib/js/pervasives.js":40}],4:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.1.0, PLEASE EDIT WITH CARE
'use strict';
...
var Parsers$BsSvgAttachment = require("./parsers.bs.js");
        ...
        var d = List.map((function (op) {
                return /* record */[
                        ...
                        /* points */List.map((function (p) {
                                return Vec2$BsSvgAttachment.$plus$caret(p, delta);
                              }), op[/* points */1])
                      ];
              }), Option.$$default(/* [] */0, Option.map(Parsers$BsSvgAttachment.parseD, Js_primitive.null_to_opt(elem.getAttribute("d")))));
        return setAttr("d", Parsers$BsSvgAttachment.genD(d), elem);
    case "polygon" : 
    case "polyline" : 
        exit = 3;
        break;
  ...
  switch (exit) {
    ...
    case 3 : 
        var points = List.map((function (p) {
                return Vec2$BsSvgAttachment.$plus$caret(p, delta);
              }), Option.$$default(/* [] */0, Option.map(Parsers$BsSvgAttachment.parsePoints, Js_primitive.null_to_opt(elem.getAttribute("points")))));
        return setAttr("points", Parsers$BsSvgAttachment.genPoints(points), elem);
    
  }
}

function getLeftTop(elem) {
  return Box$BsSvgAttachment.getBBox(elem)[/* leftTop */0];
}

function setLeftTop(vec2, elem) {
  var prev = Box$BsSvgAttachment.getBBox(elem)[/* leftTop */0];
  var delta = Vec2$BsSvgAttachment.$neg$caret(vec2, prev);
  return move(delta, elem);
}

function getRightBottom(elem) {
  return Box$BsSvgAttachment.getBBox(elem)[/* rightBottom */1];
}

function getCenter(elem) {
  var box = Box$BsSvgAttachment.getBBox(elem);
...
function setCenter(vec2, elem) {
  var delta = Vec2$BsSvgAttachment.$neg$caret(vec2, getCenter(elem));
  return move(delta, elem);
}

function zoom(ratio, elem) {
  var center = getCenter(elem);
    ...
    case "path" : 
        var d = List.map((function (op) {
                return /* record */[
                        /* operator */op[/* operator */0],
                        /* points */List.map((function (p) {
                                return Vec2$BsSvgAttachment.$star$caret(p, ratio);
                              }), op[/* points */1])
                      ];
              }), Option.$$default(/* [] */0, Option.map(Parsers$BsSvgAttachment.parseD, Js_primitive.null_to_opt(elem.getAttribute("d")))));
        return setAttr("d", Parsers$BsSvgAttachment.genD(d), elem);
...
function setSize(vec2, elem) {
  return zoom(Vec2$BsSvgAttachment.$slash$caret(vec2, getSize(elem)), elem);
}
...
function getFillColor(elem) {
  ...
  if (style.fill === "") {
    ...
    var match = Parsers$BsSvgAttachment.parseRgb(style.fill);
...
function setFillColor(color, elem) {
  ...
  if (typeof color === "number") {
    ...
    return style.fill = Parsers$BsSvgAttachment.genColor(color);
  } else {
    style.fill = Parsers$BsSvgAttachment.genColor(color);
...
function getStrokeColor(elem) {
  ...
  if (style.stroke === "") {
    ...
    var match = Parsers$BsSvgAttachment.parseRgb(style.stroke);
    if (typeof match === "number") {
      return /* None */0;
    } else if (match.tag) {
      var rgb = match[0];
...
function setStrokeColor(color, elem) {
  ...
  if (typeof color === "number") {
    ...
    return style.stroke = Parsers$BsSvgAttachment.genColor(color);
  } else {
...
},{"./box.bs.js":1,"./parsers.bs.js":3,"./vec2.bs.js":5,"bs-batteries/lib/js/src/option.js":9,"bs-platform/lib/js/block.js":14,"bs-platform/lib/js/caml_format.js":19,"bs-platform/lib/js/js_primitive.js":36,"bs-platform/lib/js/list.js":37,"bs-platform/lib/js/pervasives.js":40}],5:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.1.0, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/caml_exceptions.js":18,"bs-platform/lib/js/pervasives.js":40}],7:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.1.0, PLEASE EDIT WITH CARE
'use strict';
        ...
        if (match$5) {
          ...
          if (match$6) {
            if (match$6[1]) {
              ...
              return Mocha$BsSvgAttachment.stringEq("path 1 op", two$1[/* operator */0], "C");
            }
          } else {
            return Mocha$BsSvgAttachment.fail("not path");
          }
...
},{"../src/parsers.bs.js":3,"../src/svg.bs.js":4,"./mocha.bs.js":6,"bs-batteries/lib/js/src/option.js":9,"bs-platform/lib/js/block.js":14,"bs-platform/lib/js/js_primitive.js":36,"bs-webapi/lib/js/src/dom/nodes/ElementRe.js":46}],8:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.1.0, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/array.js":12,"bs-platform/lib/js/arrayLabels.js":13,"bs-platform/lib/js/block.js":14,"bs-platform/lib/js/caml_array.js":16,"bs-platform/lib/js/caml_builtin_exceptions.js":17,"bs-platform/lib/js/caml_exceptions.js":18,"bs-platform/lib/js/caml_int32.js":20,"bs-platform/lib/js/caml_obj.js":24,"bs-platform/lib/js/caml_oo_curry.js":26,"bs-platform/lib/js/camlinternalLazy.js":31,"bs-platform/lib/js/camlinternalOO.js":32,"bs-platform/lib/js/char.js":33,"bs-platform/lib/js/curry.js":34,"bs-platform/lib/js/list.js":37,"bs-platform/lib/js/pervasives.js":40,"bs-platform/lib/js/queue.js":41}],9:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.1.0, PLEASE EDIT WITH CARE
'use strict';
...
},{"./batEnum.js":8,"bs-platform/lib/js/caml_builtin_exceptions.js":17,"bs-platform/lib/js/caml_obj.js":24,"bs-platform/lib/js/curry.js":34}],10:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.1.0, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/block.js":14,"bs-platform/lib/js/curry.js":34}],11:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.1.0, PLEASE EDIT WITH CARE
'use strict';
...
var ParseResult$BsLittleParser = require("./parseResult.bs.js");
...
function map(p, fn, input) {
  return ParseResult$BsLittleParser.map(fn, Curry._1(p, input));
}

function $caret$caret(p, fn) {
  return (function (param) {
      return ParseResult$BsLittleParser.map(fn, Curry._1(p, param));
    });
}
...
},{"./parseResult.bs.js":10,"bs-platform/lib/js/block.js":14,"bs-platform/lib/js/caml_array.js":16,"bs-platform/lib/js/caml_string.js":27,"bs-platform/lib/js/char.js":33,"bs-platform/lib/js/curry.js":34,"bs-platform/lib/js/list.js":37,"bs-platform/lib/js/string.js":42}],12:[function(require,module,exports){
'use strict';
...
},{"./caml_array.js":16,"./caml_builtin_exceptions.js":17,"./caml_exceptions.js":18,"./curry.js":34,"./js_exn.js":35}],13:[function(require,module,exports){
'use strict';
...
},{"./array.js":12}],14:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":17,"./caml_int32.js":20,"./caml_obj.js":24,"./caml_string.js":27,"./char.js":33,"./curry.js":34,"./list.js":37,"./pervasives.js":40}],16:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":17}],17:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":17,"./caml_int32.js":20,"./caml_int64.js":21,"./caml_utils.js":29,"./curry.js":34}],20:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":17}],21:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":17,"./caml_int32.js":20,"./caml_obj.js":24,"./caml_utils.js":29}],22:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./caml_builtin_exceptions.js":17,"./curry.js":34,"_process":51}],23:[function(require,module,exports){
'use strict';
...
},{"./block.js":14,"./caml_builtin_exceptions.js":17}],25:[function(require,module,exports){
'use strict';
...
},{"./caml_array.js":16,"./caml_builtin_exceptions.js":17}],26:[function(require,module,exports){
'use strict';
...
},{"./caml_oo.js":25,"./curry.js":34}],27:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":17}],28:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./caml_builtin_exceptions.js":17,"_process":51}],29:[function(require,module,exports){
'use strict';
...
},{"./block.js":14}],31:[function(require,module,exports){
'use strict';
...
},{"./caml_exceptions.js":18,"./curry.js":34,"./obj.js":39}],32:[function(require,module,exports){
'use strict';
...
},{"./array.js":12,"./caml_array.js":16,"./caml_builtin_exceptions.js":17,"./caml_exceptions.js":18,"./caml_int32.js":20,"./caml_obj.js":24,"./caml_oo.js":25,"./caml_string.js":27,"./curry.js":34,"./list.js":37,"./obj.js":39}],33:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":17,"./caml_string.js":27}],34:[function(require,module,exports){
'use strict';
...
},{"./caml_array.js":16}],35:[function(require,module,exports){
'use strict';
...
},{"./caml_exceptions.js":18}],36:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":17,"./caml_obj.js":24,"./curry.js":34,"./pervasives.js":40}],38:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":17,"./caml_missing_polyfill.js":23,"./caml_string.js":27}],39:[function(require,module,exports){
'use strict';
...
},{"./caml_array.js":16,"./caml_builtin_exceptions.js":17,"./caml_missing_polyfill.js":23,"./marshal.js":38}],40:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":17,"./caml_exceptions.js":18,"./caml_format.js":19,"./caml_io.js":22,"./caml_missing_polyfill.js":23,"./caml_obj.js":24,"./caml_string.js":27,"./caml_sys.js":28,"./camlinternalFormatBasics.js":30,"./curry.js":34}],41:[function(require,module,exports){
'use strict';
...
},{"./caml_exceptions.js":18,"./caml_obj.js":24,"./curry.js":34}],42:[function(require,module,exports){
'use strict';
...
},{"./bytes.js":15,"./caml_int32.js":20,"./caml_string.js":27,"./list.js":37}],43:[function(require,module,exports){
'use strict';
...
},{"bs-platform/lib/js/caml_builtin_exceptions.js":17}],44:[function(require,module,exports){
'use strict';
...
},{"../DomTypesRe.js":43,"../events/EventTargetRe.js":44,"./ChildNodeRe.js":45,"./NodeRe.js":47,"./NonDocumentTypeChildNodeRe.js":48,"./ParentNodeRe.js":49,"./SlotableRe.js":50,"bs-platform/lib/js/curry.js":34,"bs-platform/lib/js/js_primitive.js":36}],47:[function(require,module,exports){
'use strict';
...
},{"../DomTypesRe.js":43,"../events/EventTargetRe.js":44}],48:[function(require,module,exports){
arguments[4][44][0].apply(exports,arguments)
