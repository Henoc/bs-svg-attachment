...
function getLeftTop(root, elem) {
  var box = Box.getRBox(elem);
  var ground = getRootLeftTop(root);
  return Vec2.$neg$caret(box[/* leftTop */0], ground);
}
...
function getRightBottom(root, elem) {
  var box = Box.getRBox(elem);
  var ground = getRootLeftTop(root);
  return Vec2.$neg$caret(box[/* rightBottom */1], ground);
}

function getCenter(root, elem) {
  var box = Box.getRBox(elem);
  var ground = getRootLeftTop(root);
  return Vec2.$neg$caret(Vec2.$plus$caret(box[/* leftTop */0], Vec2.$slash$caret(box[/* rightBottom */1], /* float array */[
                      2.0,
                      2.0
                    ])), ground);
}
...
},{"./box.bs.js":1,"./natives.bs.js":2,"./parsers.bs.js":3,"./vec2.bs.js":5,"bs-batteries/lib/js/src/option.js":9,"bs-platform/lib/js/block.js":12,"bs-platform/lib/js/caml_format.js":16,"bs-platform/lib/js/curry.js":31,"bs-platform/lib/js/js_primitive.js":33,"bs-platform/lib/js/list.js":34,"bs-platform/lib/js/pervasives.js":37}],5:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.1.0, PLEASE EDIT WITH CARE
'use strict';
...
},{"../src/svg.bs.js":4,"./mocha.bs.js":6,"bs-batteries/lib/js/src/option.js":9,"bs-platform/lib/js/block.js":12,"bs-platform/lib/js/js_primitive.js":33,"bs-webapi/lib/js/src/dom/nodes/ElementRe.js":42}],8:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.1.0, PLEASE EDIT WITH CARE
'use strict';
